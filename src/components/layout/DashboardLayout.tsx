...
export default function DashboardLayout({ children, pageTitle, role }: DashboardLayoutProps) {
  ...
  const navigation = {
    ...
    Admin: [
      ...
      { name: "Admission Panel", icon: <UserPlus size={18} />, href: "/admin/pages/admission.tsx", mod: "2" },
      ...
      { name: "Exam & Result", icon: <FileText size={18} />, href: "/dashboard/admin/pages/exam.tsx", mod: "6" },
      { name: "Others", icon: <Layers size={18} />, href: "/dashboard/admin/pages/others.jsx", mod: "7" },
      { name: "Attendance", icon: <ClipboardCheck size={18} />, href: "/dashboard/admin/pages/attendance.jsx", mod: "8" },
      { name: "Bill", icon: <Receipt size={18} />, href: "/dashboard/admin/pages/bill.tsx", mod: "9" },
      { name: "Accounts", icon: <Landmark size={18} />, href: "/dashboard/admin/pages/accounts.jsx", mod: "10" },
